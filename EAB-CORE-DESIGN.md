# EAB Core Design — IPAM Driver, Agent, and Master
...
> This is the **technical reference** for the EAB core components. The entry point for the
> overall concept — fixed design decisions, system invariants, and the milestone plan — is
> the [README](README.md); the external NAT realization path is specified in
> [EXTERNAL-NAT-REALIZATION.md](EXTERNAL-NAT-REALIZATION.md).
